    ...
    <div className={`w-full ${className}`}>
      ...
      <div className="relative rounded-xl">
        ...
        <input
          ...
          className={`w-full rounded-xl border bg-white px-3.5 py-2.5 text-sm text-slate-900 placeholder-slate-400 transition-colors focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-brand-500 disabled:bg-slate-50 disabled:text-slate-500 ${
            Icon ? 'pl-10' : ''
          } ${endAdornment ? 'pr-11' : ''} ${
            error
